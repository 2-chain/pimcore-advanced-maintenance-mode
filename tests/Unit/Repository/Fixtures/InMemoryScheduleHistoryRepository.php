...
final class InMemoryScheduleHistoryRepository implements ScheduleHistoryRepositoryInterface
{
    ...
    #[Override] public function findInProgressIdByWindowId(string $windowId): ?int
    {
        return null;
    }

    #[Override] public function isInProgress(int $id): bool
    {
        return false;
    }
    ...
    #[Override] public function count(?string $scheduleWindowId = null): int
    {
        return 0;
    }
    ...
    public function wasEndUpdated(int $id): bool
    {
