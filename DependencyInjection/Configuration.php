                    ...
                    ->children()
                        ->arrayNode('webhooks')
                            ->scalarPrototype()
                                ->cannotBeEmpty()
                                ->validate()
                                    ->ifTrue(static fn($v) => !\in_array(\parse_url((string) $v, \PHP_URL_SCHEME), ['http', 'https'], true))
                                    ->thenInvalid('Webhook URL must use http:// or https://')
                                ->end()
                            ->end()
                            ->defaultValue([])
                        ->end()
                            ...
                            ->arrayPrototype()
                                ...
                                ->children()
                                    ...
                                    ->scalarNode('url')
                                        ->defaultNull()
                                        ->validate()
                                            ->ifTrue(static fn($v) => $v !== null && !\in_array(\parse_url((string) $v, \PHP_URL_SCHEME), ['http', 'https'], true))
                                            ->thenInvalid('health_checks.checks[].url must use http:// or https://')
                                        ->end()
                                    ->end()
